...
typedef struct AVD3D11VADeviceContext {
    ...
    /**
     * If unset, this will be set from the device field on loadStart.
     *
     * Deallocating the AVHWDeviceContext will always release this interface,
     * and it does not matter whether it was user-allocated.
     */
    ...
    /**
     * If unset, this will be set from the device_context field on loadStart.
     *
     * Deallocating the AVHWDeviceContext will always release this interface,
     * and it does not matter whether it was user-allocated.
     */
     ...
     *
     * If unset on loadStart, the hwcontext implementation will set them to use an
     * internal mutex.
     *
...
typedef struct AVD3D11VAFramesContext {
     ...
     * on loadStart, the hwframes implementation will allocate and set an array
