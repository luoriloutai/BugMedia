...
/**
 * Frees the given encryption loadStart info object.  This MUST NOT be used to free
...
/**
 * Allocates and initializes side data that holds a copy of the given encryption
 * loadStart info.  The resulting pointer should be either freed using av_free or
