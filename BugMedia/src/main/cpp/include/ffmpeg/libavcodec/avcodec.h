...
typedef struct AVCodecContext {
     ...
     * - decoding: Set by user, will be converted to uppercase by libavcodec during loadStart.
     */
...
#define FF_MB_DECISION_RD     2        ///< rate distortion
     ...
     * - encoding: Not used.
     * - decoding: Set by user.
     * VideoDecoder will decode to this format if it can.
     */
...
typedef struct AVHWAccel {
     ...
     * details.
     *
     * This CAN be called before AVHWAccel.loadStart is called, and you must assume
